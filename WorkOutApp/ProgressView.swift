...
extension TimerView {
    final class ProgressView: UIView {
        func drawProgress(with percent: CGFloat) {
            layer.sublayers?.removeAll() //удаляем все предыдущие слои при анимации!
            ...
            defaultCircleLayer.strokeColor = Resourses.Colors.seporator.cgColor
            ...
            (1...9).forEach { _ in
                ...
                ? Resourses.Colors.active.cgColor : Resourses.Colors.seporator.cgColor
